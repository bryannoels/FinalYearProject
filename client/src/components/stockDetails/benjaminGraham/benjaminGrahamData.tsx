...
export const getDefensiveData = (stockData: Stock) => ({
    "Revenue": {
      value: stockData.detail?.totalRevenue ?? "N/A",
      description: "Revenue refers to the total income generated by the company from its business activities.",
      color: parseFloat(stockData.detail?.totalRevenue ?? "0") < 100000000 ? "red" : "green",
    },
    "Current Ratio": {
      ...
      color: parseFloat(stockData.detail?.currentRatio ?? "0") < 2 ? "red" : "green",
    },
    "Earnings Stability": {
    ...
    "Price/Assets Ratio": {
      value: priceToAssetRatio(stockData.peRatio ?? [], stockData.detail?.priceToBook ?? "Not found"),
      description: "This measures the ratio of the stock price to the book value of the company's assets.",
      color:
        priceToAssetRatio(stockData.peRatio ?? [], stockData.detail?.priceToBook ?? "Not found") === "N/A" ||
        parseFloat(priceToAssetRatio(stockData.peRatio ?? [], stockData.detail?.priceToBook ?? "Not found")) > 22.5
          ? "red"
          : "green",
    },
...
export const getEnterprisingData = (stockData: Stock) => ({
    "Revenue": {
      value: stockData.detail?.totalRevenue ?? "N/A",
      description: "Revenue refers to the total income generated by the company from its business activities.",
      color: parseFloat(stockData.detail?.totalRevenue ?? "-1" ) <= 0 ? "red" : "green",
    },
    "Current Ratio": {
      value: stockData.detail?.currentRatio ?? "N/A",
      description: "The current ratio measures the company's current assets against its current liabilities.",
      color: parseFloat(stockData.detail?.currentRatio ?? "0") < 1.5 ? "red" : "green",
    },
    "Earnings Stability": {
    ...
    "Price/Assets Ratio": {
      value: priceToAssetRatio(stockData.peRatio ?? [], stockData.detail?.priceToBook ?? "Not found"),
      description: "This measures the ratio of the stock price to the book value of the company's assets.",
      color: (stockData.detail?.priceToBook === null || parseFloat(priceToAssetRatio(stockData.peRatio ?? [], "Not found")) > 18)
          ? "red"
          : "green",
    },
    "Investor Suitability": {
