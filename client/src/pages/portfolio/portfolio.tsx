...
import CustomDialogBox from '../../components/aCustomDialogBox/CustomDialogBox';
    ...
    Object.keys(portfolioSearchTerms).forEach((portfolioName) => {
      if (portfolioSearchTerms[portfolioName].length >= 1) {
        timeouts[portfolioName] = setTimeout(() => {
          searchStocks(portfolioSearchTerms[portfolioName], setAddStockResult);
        }, 200);
      }
    });
