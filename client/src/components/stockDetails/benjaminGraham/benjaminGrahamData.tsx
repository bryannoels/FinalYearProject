...
export const getDefensiveData = (stockData: Stock) => ({
    ...
    "Earnings Growth": {
      ...
      color: hasEarningsIncreased(stockData.eps, "defensive") ? "green" : "red",
    },
    "Price/Earnings Ratio": {
      ...
      color: threeYearsPeRatio(stockData.peRatio) ? "green" : "red",
    },
    "Price/Assets Ratio": {
      value: priceToAssetRatio(stockData.peRatio, stockData.detail?.priceToBook, 22.5),
...
export const getEnterprisingData = (stockData: Stock) => ({
    ...
    "Earnings Growth": {
      ...
      color: hasEarningsIncreased(stockData.eps, "enterprising") ? "green" : "red",
    },
    "Price/Earnings Ratio": {
    ...
    "Price/Assets Ratio": {
      value: priceToAssetRatio(stockData.peRatio, stockData.detail?.priceToBook, 18),
      description: "This measures the ratio of the stock price to the book value of the company's assets.",
      color: priceToAssetRatio(stockData.peRatio, stockData.detail?.priceToBook, 18) ? "green" : "red",
    },
    "Investor Suitability": {
