...
const getStockData = (req, res) => {
    ...
    const pythonProcess = (0, child_process_1.spawn)('python3', ['src/stocks/getStockData.py', stockSymbol]);
...
const getAnalysis = (req, res) => {
    const stockSymbol = req.params.symbol.toUpperCase();
    const pythonProcess = (0, child_process_1.spawn)('python3', ['src/stocks/getAnalysis.py', stockSymbol]);
    pythonProcess.stdout.on('data', (data) => {
        try {
...
const getHistoricalData = (req, res) => {
    ...
    const pythonProcess = (0, child_process_1.spawn)('python3', ['src/stocks/getHistoricalData.py', stockSymbol, rangeParam]);
    pythonProcess.stdout.on('data', (data) => {
        try {
...
const getEPSData = (req, res) => {
    const stockSymbol = req.params.symbol.toUpperCase();
    const pythonProcess = (0, child_process_1.spawn)('python3', ['src/stocks/getEPSData.py', stockSymbol]);
    pythonProcess.stdout.on('data', (data) => {
        try {
...
const getPeRatioData = (req, res) => {
    const stockSymbol = req.params.symbol.toUpperCase();
    const pythonProcess = (0, child_process_1.spawn)('python3', ['src/stocks/getPeRatioData.py', stockSymbol]);
    pythonProcess.stdout.on('data', (data) => {
        try {
            const epsData = JSON.parse(data.toString());
            if (!res.headersSent) {
...
const getAaaCorporateBondYield = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const pythonProcess = (0, child_process_1.spawn)('python3', ['src/stocks/getAaaCorporateBondYield.py']);
    pythonProcess.stdout.on('data', (data) => {
        try {
            const stocksData = JSON.parse(data.toString());
            if (!res.headersSent) {
...
const searchStock = (req, res) => {
    ...
    const pythonProcess = (0, child_process_1.spawn)('python3', ['src/stocks/searchStock.py', query]);
    pythonProcess.stdout.on('data', (data) => {
        try {
            const stockData = JSON.parse(data.toString());
            if (!res.headersSent) {
